...
The equivalence between the two semantics is possible under two conditions:
we need to work with "valid states", i.e. state that can be generated from
a query of type call.
