...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.4\textwidth}
    ...
    \caption{Step on g X Y}
    \label{tree-ex1-exp} 
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \includestandalone[width=.7\textwidth]{./src/tree_cut}
...
containing then atoms (either cut or call) 
...
g X Y and, in the program above, the new tree would be the one in
...
r2 and r3. \marginpar{dire che le sostituzioni del backchain sono importanti}

\textit{Cut step} The latter case is more delicate since performing a cut
in a tree has 
